...
*/
		...
		posGod = new Vector3(0f, 2f, 1f + (Shooter.HasFired?10f:1f))	 - posGod;

		Aim.AimX = -posGod.x;
		Aim.AimY = posGod.y;

		//posGod += new Vector3(0f,-2f,0f);

		FalconUnity.setForceField(falcon_num, posGod * -2f);
